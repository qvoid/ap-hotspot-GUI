...
case "$1" in
	...
	debug)
			...
			start;;
	*)
			args=( "check" "vars" "start" "stop" "restart" "configure" "debug" )
			desc=( "check if your wireless card is supported" "echo vars" "start wireless hotspot" "stop wireless hotspot" "restart wireless hotspot" "configure hotspot" "start with detailed messages" )
